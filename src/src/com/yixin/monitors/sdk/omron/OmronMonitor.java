...
public class OmronMonitor implements ApiMonitor {
	...
	private boolean mIsBinded; // 服务是否已经绑定
	...
	public void connect() {
		...
		if (mConnection == null) {
			mConnection = new OmronBluetoothConnection(mContext,
					getDeviceInfo(), mBluetoothListener, this);
	...
	private void startService() {
		...
		mContext.bindService(mHealthservice, mServiceConnection,
